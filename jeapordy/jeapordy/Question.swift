...
public class Trivia{
    ...
    static func getTrivia() -> [String: [Trivia]]{
    return [
        "General Knowledge" :
        [
    ...
    static func getCategories() -> [String]{
        ...
        for category in Trivia.getTrivia().keys{
            categories.append(category)
        }
        return categories
    }
    
    static func getQuestions(category : String) -> [Trivia]?{
        guard !category.isEmpty else {return nil}
        guard getTrivia().keys.contains(category) else {return nil}
        return getTrivia()[category]!
    }
}
